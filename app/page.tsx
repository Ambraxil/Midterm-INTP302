      ...
      <div className="flex w-2/6 flex-col p-10">
        ...
        <div className="bg-[#E3D5CA] p-10 border border-zinc-400 rounded-2xl text-black">
          ...
          <button
            ...
            className="bg-[#F5EBE0] pt-2 pb-2 mt-5 border border-zinc-500 text-black font-semibold rounded-2xl w-full disabled:opacity-50 flex items-center justify-center gap-2 hover:bg-[#eddcd0] transition-colors"
          >
        ...
        <div className="mt-10">
          ...
          {isFetching ? (
            ...
            posts.map((post, i) => (
              <div
                key={i}
                className="border border-zinc-400 p-3 mb-3 bg-[#F5EBE0] rounded-2xl shadow-sm"
              >
